...
<Steps>
  <Step title="Part C: Input Prep & ANOVA">
    1. <b>sql_query</b> – Filter phenotype data with SQL<br/>
    2. <b>id_conversion</b> – Convert subject IDs and prepare phenotype table<br/>
    3. <b>wes_id_mapping</b> – Map phenotype IDs to WES column names<br/>
    4. <b>rsids_for_genes</b> – Extract rsIDs for gene lists<br/>
    5. <b>filter_by_rsid</b> – Filter variants by RSID list
  </Step>
  <Step title="Part D: Filtering & Frequency Analysis">
    6. <b>filter_coding_variants</b> – Filter variants to coding rsIDs only<br/>
    7. <b>cohort_allele_freq</b> – Compute cohort allele frequencies<br/>
    8. <b>reference_allele_freq</b> – Look up European reference frequencies<br/>
